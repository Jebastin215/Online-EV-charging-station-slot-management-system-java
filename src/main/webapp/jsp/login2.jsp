                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item active"><a href="${pageContext.request.contextPath}/login2"
                                    class="nav-link">Charging Station</a></li>
                            <li class="nav-item"><a href="${pageContext.request.contextPath}/login_admin"
                ...
                <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                        <div class="col-md-9 ftco-animate pb-5">
                            ...
                            <h1 class="mb-3 bread">Station Login</h1>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row d-flex mb-5 contact-info">
                        ...
                        <div class="col-md-8 block-9 mb-md-5">
                            ...
                            <br>
                            <a href="${pageContext.request.contextPath}/reg_station">Register here</a>
                        </div>
                    </div>
