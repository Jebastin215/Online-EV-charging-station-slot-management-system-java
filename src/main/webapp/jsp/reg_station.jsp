        ...
        <head>
            ...
            <script language="javascript">
                function validate() {
                    ...
                    if (document.form1.num_charger.value == "") {
                        alert("Enter the Number of Charging Slot");
                        document.form1.num_charger.focus();
                        return false;
                    }
                    if (document.form1.num_charger.value > 12) {
                        alert("More than 12 not allowed!");
                        document.form1.num_charger.select();
                        return false;
                    }
                    if (isNaN(document.form1.num_charger.value)) {
                        alert("Invalid!");
                        document.form1.num_charger.select();
                        return false;
                    }
                    ...
                    <div class="row d-flex mb-5 contact-info">
                        ...
                        <div class="col-md-8 block-9 mb-md-5">
                            ...
                            <c:if test="${msg eq 'success'}">
                                <span style="color:#006666">Registered Success, wait for Approval!</span>
                                <script>
                            ...
                            <form name="form1" action="${pageContext.request.contextPath}/reg_station" method="post"
                                ...
                                <div class="form-group">
                                    <input type="text" name="num_charger" class="form-control"
                                ...
                                <a href="https://developers-dot-devsite-v2-prod.appspot.com/maps/documentation/utils/geocoder"
                                    target="_blank">Get Location</a></li>
                            </form>
