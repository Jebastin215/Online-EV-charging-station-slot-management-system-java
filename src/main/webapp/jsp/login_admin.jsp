                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item active"><a href="${pageContext.request.contextPath}/login_admin"
                ...
                <div class="container">
                    <div class="row d-flex mb-5 contact-info">
                        ...
                        <div class="col-md-8 block-9 mb-md-5">
                            ...
                            <form name="form1" action="${pageContext.request.contextPath}/login_admin" method="post"
